            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "请输入对话内容",
                  hintStyle: TextStyle(fontSize: 14, color: Styles.black515A6E),
                  contentPadding: const EdgeInsets.only(left: 16),
                  enabledBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: Styles.divider, width: 1),
                    borderRadius: BorderRadius.circular(10),
                  ),
                  focusedBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: Styles.blue247AF2, width: 1),
                    borderRadius: BorderRadius.circular(10),
                  ),
